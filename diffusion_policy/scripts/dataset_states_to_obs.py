...
Example usage:
    ...
    python dataset_states_to_obs.py --dataset /home/ns1254/diffusion_policy/data/dp_logs/can_bc_mh_img_better/rollouts/epoch_20.hdf5 --output_name /home/ns1254/diffusion_policy/data/dp_logs/can_bc_mh_img_better/rollouts/epoch_20_low_dim2.hdf5 --done_mode 2
    

    python dataset_states_to_obs.py --dataset /home/ns1254/diffusion_policy/data/can_mh_demo_raw.hdf5 --output_name /home/ns1254/diffusion_policy/data/can_mh_demo_raw_low_dim.hdf5 --done_mode 2
    
    /home/ns1254/diffusion_policy/data/can_mh_demo_raw.hdf5
...
# obs_keys={'low_dim': ['object', 'robot0_eef_pos', 'robot0_eef_quat', 'robot0_gripper_qpos'] }
def dataset_states_to_obs(args, obs_keys={'low_dim':['object']}):
...
if __name__ == "__main__":
    ...
    obs_keys={'low_dim': ['object', 'robot0_eef_pos', 'robot0_eef_quat', 'robot0_gripper_qpos'] }
    dataset_states_to_obs(args, obs_keys=obs_keys)
